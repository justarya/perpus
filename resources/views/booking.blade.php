...
<table class="table">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td class="td-action"><a href="/peminjaman/booking/konfirmasi/{{$peminjaman->id}}">Konfirmasi</a> | <a href="javascript:void(0)" onclick="confirmURL('Apakah Anda Yakin Mau Membatalkannya?','/peminjaman/booking/cancel/{{$peminjaman->id}}')">Cancel</a></td>
    </tr>
    @endforeach
  </tbody>
</table>
